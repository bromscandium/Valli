...
const API_URL_ADD = "https://api.example.com/projects"; // Replace with your actual API URL
const API_URL_GET = "https://api.example.com/projects"; // Replace with your actual API URL
    ...
    try {
        const response = await axios.get(API_URL, {
            ...
            params: {
                ...
                crop_purpose: form.crop_purpose,
                selling_method: form.selling_method,
                expected_yield_per_acre: form.expected_yield_per_acre,
                expected_price_per_kg: form.expected_price_per_kg,
                typical_costs_per_acre: form.typical_costs_per_acre,
                irrigation_costs_per_season_per_acre: form.irrigation_costs_per_season_per_acre,
                labor_or_machinery: form.labor_or_machinery,
                labor_machinery_costs_per_season_per_acre: form.labor_machinery_costs_per_season_per_acre,
            },
        });

        return response.data.projects; // Adjust according to your API response structure
    } catch (error) {
