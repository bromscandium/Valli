...
from .config import QDRANT_CLIENT_HOST, json_summary_plan_schema, summary_prompt, GEMINI_PROMPT, OPENAI_API, predefined_questions, build_conversation, build_chat_conversation, update_chat_conversation, CREATE_PROJECT_PROMPT, create_project_schema, CONVERSATION_PROMPT, OpenWeatherApi, WEATHER_PROMPT, weather_json_schema, coordinates_schema
